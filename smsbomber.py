...
#------------------------------------------------------#
#                   SMS_BOMBER 2.1 !                  #
#               Coded by Worthless Hackers              #
#~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ #
#      Github     :   github.com/worthlesshackers420/      #     #
#------------------------------------------------------#
...
echo ""
sleep 1
echo "                                    $WHITE Author:$RED Worthless Hackers"
echo ""

}

#    Check Internet
wget -q --spider https://github.com/worthlesshackers
...
wget -L https://raw.githubusercontent.com/worthlesshackers/serversms/main/.server.txt  > /dev/null 2>&1
serverup="On"
...
cd ..
rm -rf SMS_BOMBER
git clone https://github.com/worthlesshackers/SMS_BOMBER > /dev/null 2>&1
cd SMS_BOMBER
chmod +x sms.sh
clear
echo ""
...
''' | pv -qL 300
sleep 1.2
echo -e "                                  This is\e[1;0m Worthless Hackers" | pv -qL 150
echo "                                    aka worthlesshackers !" | pv -qL 150
echo ""
...
echo ""
printf "\e[0m\e[92m          Github \e[0m\e[91m     :    \e[0m\e[96mgithub.com/worthlesshackers\e[0m\n" | pv -qL 50
echo ""
printf "\e[0m\e[92m         Instagram \e[0m\e[91m   :   \e[0m\e[96minstagram.com/worthlesshackers\e[0m\n" | pv -qL 50
echo ""
...
printf "  $RED                     ░░░░░░███████ ]▄▄▄▄▄▄▄▄▃\n"
printf "  $WHITE                      ▂▄▅███\e[1;31mSMS\e[1;0m███▅▄▃▂\n"
printf "  $RED                    I███████████████████]\n"
printf "  $WHITE                      ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤...\n"
echo ""
